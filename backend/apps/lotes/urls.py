...
from .views import LoteCloseView, LoteCriasView, LoteDetailView, LoteHembrasView, LoteListCreateView
...
urlpatterns = [
    ...
    path("<uuid:pk>/crias/", LoteCriasView.as_view(), name="lotes-crias"),
]
